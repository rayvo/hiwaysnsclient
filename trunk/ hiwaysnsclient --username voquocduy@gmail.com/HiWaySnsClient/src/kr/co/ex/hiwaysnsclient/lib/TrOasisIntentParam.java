...
public class TrOasisIntentParam implements Parcelable 
{
	/*
	 * Constant 정의.
	 */
	...
	public	int		mPollType			= TrOasisConstants.TROASIS_COMM_TYPE_STATUS;
	...
	*/
	 ...
	 * Override 정의.
	 */
	public	static	final	Parcelable.Creator<TrOasisIntentParam> CREATOR = new Parcelable.Creator<TrOasisIntentParam>()
	{
		public TrOasisIntentParam createFromParcel(Parcel in)
		{
			return new TrOasisIntentParam(in);
		}
		
		public TrOasisIntentParam[] newArray(int size)
		{
			return new TrOasisIntentParam[size];
		}
	};
	...
	private TrOasisIntentParam(Parcel in)
	{
	 ...
	 * Method 정의.
	 */
	public	TrOasisIntentParam()
	{
		mPollType			= TrOasisConstants.TROASIS_COMM_TYPE_STATUS;
