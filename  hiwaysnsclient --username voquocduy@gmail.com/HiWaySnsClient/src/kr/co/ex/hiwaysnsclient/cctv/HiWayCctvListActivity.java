...
public class HiWayCctvListActivity extends HiWayBasicActivity
{
	...
	private		String[]	mListName	=	{	
								"[1] 경부고속도로",		"[10] 남해고속도로",		"[12] 88올림픽고속도로",	"[14] 고창담양선"
								, "[15] 서해안고속도로",	"[16] 울산선고속도로",		"[17] 서천공주선",			"[250] 호남고속도로"
								, "[30] 대전당진선",		"[35] 중부고속도로(통영-대전 포함)",	"[37] 제2중부고속도로"
								, "[40] 평택제천간고속도로",	"[45] 중부내륙고속도로",	"[50] 영동고속도로",		"[550] 중앙고속도로"
								, "[65] 동해고속도로",		"[100] 서울외곽순환고속도로",	"[102] 남해제1고속도로지선",	"[104] 남해제2고속도로지선",		"[110] 제2경인고속도로"
								, "[120] 경인고속도로"
								, "[251] 호남고속도로지선",	"[300] 대전남부순환고속도로",	"[451] 중부내륙고속도로지선"
								, "[551] 중앙고속도로지선"
											};
