...
public class ElveLocation
{
	 ...
	 * Method 정의.
	 */
	public	ElveLocation( Context context )
	{
		mContext	= context;
	...
	class	TrOasisTimerDirveAuto	extends TimerTask
	{
		public	void	run()
		{
			...
			long	currentTime	= CommClient.getCurrentTimestamp();
			String	strCurrent	= CommClient.getTimestampString( currentTime );
